 ...
 * @author Eduardo
 */
public class NotaController implements Initializable, PaneController{
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        numero.setCellValueFactory((CellDataFeatures<Nota, String> p) -> new ReadOnlyObjectWrapper(p.getValue().getNumero()));
        ...
        this.notasResult = Cliente.INSTANCIA.getUltimasNotas(50);
    ...
    private void visualizar(Nota nota){
        ...
        controller.setModuloVoltar(Modulos.NOTA);
