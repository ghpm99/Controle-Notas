 ...
 */
public class SemContratoController implements Initializable,PaneController {
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        faturamentoDireto.setCellValueFactory(new PropertyValueFactory("faturamentoDireto"));
        ...
        this.notasResult = Cliente.INSTANCIA.buscarNotaProblema();
    ...
    private void visualizar(Nota nota){
        ...
        controller.setModuloVoltar(Modulos.NOTASEMCONTRATO);
...
//                limparTabela();
//                Cliente.INSTANCIA.buscar("NOTA", campos.getValue(), campo.getText()).stream().forEach(s -> {
//                    addNota(Cliente.INSTANCIA.buscarNota(s));
//                });
//                return null;
//            }
//
...
//                atualizar();
//                carregar.fechar();
//                status.setText(notasResult.size() + " resultados encontrados para " + campo.getText());
//                pai.setDisable(false);
//                campo.requestFocus();
//                campo.selectAll();
//            }
